...
namespace IKVM.CoreLib.Linking
{
    ...
    /// </summary>
    sealed class ConstantPoolItemInteger<TLinkingType, TLinkingMember, TLinkingField, TLinkingMethod> : ConstantPoolItem<TLinkingType, TLinkingMember, TLinkingField, TLinkingMethod>
        ...
        where TLinkingMethod : class, ILinkingMethod<TLinkingType, TLinkingMember, TLinkingField, TLinkingMethod>, TLinkingMember
    {
        ...
        internal ConstantPoolItemInteger(ILinkingContext<TLinkingType, TLinkingMember, TLinkingField, TLinkingMethod> context, IntegerConstantData data) :
            base(context)
        {
            _value = data.Value;
        }

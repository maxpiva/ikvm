...
namespace IKVM.CoreLib.Linking
{
    ...
    /// </summary>
    sealed class ConstantPoolItemFloat<TLinkingType, TLinkingMember, TLinkingField, TLinkingMethod> : ConstantPoolItem<TLinkingType, TLinkingMember, TLinkingField, TLinkingMethod>

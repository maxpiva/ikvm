...
namespace IKVM.Tools.Importer
{
    ...
    class ProxyGenerator
    {
        ...
        void CreateMethod(ImportClassLoader loader, TypeBuilder tb, ProxyMethod pm)
        {
            ...
            ilgen.EmitLdc_I4(0);
            ilgen.Emit(OpCodes.Call, loader.Context.ByteCodeHelperMethods.MapException.MakeGenericMethod(loader.Context.Types.Exception, loader.Context.Types.Exception));

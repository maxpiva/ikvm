    ...
    sealed class NativeInvokerBytecodeGenerator
    {
        ...
        private Delegate generateCustomizedCodeBytes()
        {
            ...
            for (int i = lambdaForm._arity(); i < lambdaForm.names.Length; i++)
            {
                ...
                java.lang.invoke.MethodHandleImpl.Intrinsic intr = name.function.intrinsicName();
                switch (intr.name())
                {
                ...
                java.lang.invoke.MemberName member = name.function._member();
        ...
        void emitInvoke(Name name)
        {
            ...
            {
                // push receiver
                java.lang.invoke.MethodHandle target = name.function._resolvedHandle();
            ...
            // invocation
            java.lang.invoke.MethodType type = name.function.methodType();
        ...
        */
         ...
         */
        void emitStaticInvoke(java.lang.invoke.MemberName member, Name name)
        {
            // push arguments
            emitPushArguments(name);
        ...
        private Name emitGuardWithCatch(int pos)
        {
            ...
            java.lang.invoke.MethodType type = args.function._resolvedHandle().type()
            ...
            ilgen.EmitLdc_I4(0);
            ilgen.Emit(OpCodes.Call, context.ByteCodeHelperMethods.MapException.MakeGenericMethod(typeof(Exception), typeof(Exception)));
